		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/">${cname }&nbsp;&nbsp;&gt;</a>
					<a>${product.pname }</a>
				</div>
				...
				<form id="myForm" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart" method="post">
					...
					${product.pname } :通过获取到的product对象调用上的getPname()方法。
					...
					-->
						...
						<div style="margin:10px 0 10px 0;">促销: <a target="_blank" title="限时抢购 (2018-07-30 ~ 2019-01-01)" style="background-color: #f07373;">限时抢购</a> </div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								<%--加入到购物车 --%>
								<a href="javascript:void(0)"> <!-- 取消连接的默认行为 -->
