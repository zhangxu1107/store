			...
			<div id="carousel-example-generic" class="carousel slide"
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<a href="https://item.mi.com/product/10000099.html"><img src="${pageContext.request.contextPath }/img/ad/4.jpg"
							style="height: 700px"></a>
						<div class="carousel-caption"></div>
					</div>
					<div class="item">
						<a href="https://item.mi.com/product/10000115.html"><img src="${pageContext.request.contextPath }/img/ad/5.jpg"
							style="height: 700px"></a>
						<div class="carousel-caption"></div>
					</div>
					<div class="item">
						<a href="http://www.mi.com/mitv4c/40/"><img src="${pageContext.request.contextPath }/img/ad/6.jpg"
							style="height: 700px"></a>
						<div class="carousel-caption"></div>
					</div>
				</div>
		...
		<div class="container-fluid">
			...
			<div class="col-md-10">
				<div class="col-md-6"
					...
					<a href="${pageContext.request.contextPath }/ProductServlet?method=findProductByPid&pid=1"> <img
