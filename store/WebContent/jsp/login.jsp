...
<div class="container"  style="width:100%;height:680px;background:#FF2C4C url('${pageContext.request.contextPath}/img/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="autoLogin" value="yes" checked="checked"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="checkbox"  name="remUser" value="yes" checked="checked"> 记住用户名
        </label>
      </div>
    </div>
  </div>
